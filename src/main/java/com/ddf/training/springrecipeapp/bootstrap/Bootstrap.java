...
public class Bootstrap implements CommandLineRunner {
    ...
    private void loadSpicyGrilledChikenTacos(){
        ...
        spicyGrilledChickenTacos.setDirection("<ol><li>Prepare a gas or charcoal grill for medium-high, direct heat.</li>\n" +
                ...
                "\n" +
                "<li>3 Grill the chicken: Grill the chicken for 3 to 4 minutes per side, or until a thermometer inserted into the thickest part of the meat registers 165F. Transfer to a plate and rest for 5 minutes.</li>\n" +
                "\n" +
                "<li>4 Warm the tortillas: Place each tortilla on the grill or on a hot, dry skillet over medium-high heat. As soon as you see pockets of the air start to puff up in the tortilla, turn it with tongs and heat for a few seconds on the other side.\n" +
                "\n" +
    ...
    private void loadPerfectGuacamole() {
        ...
        perfectGuacamole.setDirection("<ol><li> Cut the avocado, remove flesh: Cut the avocados in half. Remove the pit. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon. (See How to Cut and Peel an Avocado.) Place in a bowl.</li>\n" +
                ...
                "\n" +
                "<li> Serve: Serve immediately, or if making a few hours ahead, place plastic wrap on the surface of the guacamole and press down to cover it and to prevent air reaching it. (The oxygen in the air causes oxidation which will turn the guacamole brown.) Refrigerate until ready to serve.</li></ol>\n" +
                "\n" +
                "\n" +
                " \n");
