...
public class Bootstrap implements CommandLineRunner {
    ...
    private void loadSpicyGrilledChikenTacos(){
        ...
        spicyGrilledChickenTacos.setDirection("1 Prepare a gas or charcoal grill for medium-high, direct heat.\n" +
                "\n" +
    ...
    private void loadPerfectGuacamole() {
        ...
        perfectGuacamole.setDirection("1 Cut the avocado, remove flesh: Cut the avocados in half. Remove the pit. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon. (See How to Cut and Peel an Avocado.) Place in a bowl.\n" +
                "\n" +
